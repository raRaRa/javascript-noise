var SimplexNoise3D = (function () {
    ...
    //    inx[2] = inx[2] - Math.floor(inx[2] * (mod289_temp0)) * 289.0;
    //};
    ...
    function snoise_vec3(inX, inY, inZ) {
        ...
        i[2] = i[2] - Math.floor(i[2] * (mod289_temp0)) * 289.0;
        ...
        p[0] = perm[ (perm[ perm[i[2] + 0.0   ] + i[1] + 0.0   ] + i[0] + 0.0  ) & 511 ];
        p[1] = perm[ (perm[ perm[i[2] + i1[2] ] + i[1] + i1[1] ] + i[0] + i1[0]) & 511 ];
        p[2] = perm[ (perm[ perm[i[2] + i2[2] ] + i[1] + i2[1] ] + i[0] + i2[0]) & 511 ];
        p[3] = perm[ (perm[ perm[i[2] + 1.0   ] + i[1] + 1.0   ] + i[0] + 1.0  ) & 511 ];
        ...
        sh[0] = 0.0 < h[0] ? -0.0 : -1.0;
        sh[1] = 0.0 < h[1] ? -0.0 : -1.0;
        sh[2] = 0.0 < h[2] ? -0.0 : -1.0;
        sh[3] = 0.0 < h[3] ? -0.0 : -1.0;
        ...
        norm[0] = 1.79284291400159 - 0.85373472095314 * (a0[0] * a0[0] + a0[1] * a0[1] + h[0] * h[0]);//vec3.dot(p0, p0);
        norm[1] = 1.79284291400159 - 0.85373472095314 * (a0[2] * a0[2] + a0[3] * a0[3] + h[1] * h[1]);//vec3.dot(p1, p1);
        norm[2] = 1.79284291400159 - 0.85373472095314 * (a1[0] * a1[0] + a1[1] * a1[1] + h[2] * h[2]);//vec3.dot(p2, p2);
        norm[3] = 1.79284291400159 - 0.85373472095314 * (a1[2] * a1[2] + a1[3] * a1[3] + h[3] * h[3]);
